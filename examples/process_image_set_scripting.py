...
graphics = sys.argv[3] == "True" # set True for graphics throughout the solve process

# sys.stdin[1]
data_path = r'C:\Users\Ethan\Desktop\COTS-Star-Tracker-Amalthea\data' # full path to your data
image_path = r'C:\Users\Ethan\Desktop\COTS-Star-Tracker-Amalthea\data' # full path to your images
cam_config_file_path = sys.argv[1] # full path (including filename) of your cam config file
...
image_extension = sys.argv[2] # the image extension to search for in the data_path directory
